...
import { PostFragmentFragment } from './Post.fragment.generated';
...
export type PostCreatedSubscriptionVariables = Types.Exact<{ [key: string]: never; }>;


export type PostCreatedSubscription = (
  { __typename?: 'Subscription' }
  & { postCreated?: Types.Maybe<(
    { __typename?: 'Post' }
