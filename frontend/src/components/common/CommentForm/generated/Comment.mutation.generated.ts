...
export type CreateCommentMutationVariables = Types.Exact<{
  ...
  attachToId: Types.Scalars['MongoID'];
  attachToType: Types.ThreadsEnum;
}>;


export type CreateCommentMutation = (
  { __typename?: 'Mutation' }
  & { commentCreate?: Types.Maybe<(
    { __typename?: 'CommentTC' }
    & { record?: Types.Maybe<(
      { __typename?: 'Comment' }
      & Pick<Types.Comment, '_id'>
    )> }
  )> }
);
...
export const CreateCommentDocument = gql`
    mutation CreateComment($comment: CommentInput!, $attachToId: MongoID!, $attachToType: ThreadsEnum!) {
  commentCreate(
    record: $comment
 ...
 *      attachToType: // value for 'attachToType'
 *   },
 * });
 */
